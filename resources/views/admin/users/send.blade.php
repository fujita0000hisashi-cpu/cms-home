...
<section class="send">
	<div class="contactMainBox">
		...
		<div class="dataContentItem">
			<p class="dataContentItemP">メールアドレス:{{ $user['mail'] }}</p>
		</div>
		<div class="dataContentItem">
		...
		<div class="dataContentItem">
			<p class="dataContentItemP">郵便番号:{{ $user['postcode'] }}</p>
		</div>
		<div class="dataContentItem">
			<p class="dataContentItemP">都道府県:{{ $user['prefecture'] }}</p>
		</div>
		<div class="dataContentItem">
			<p class="dataContentItemP">市町村:{{ $user['city'] }}</p>
		</div>
		<div class="dataContentItem">
			<p class="dataContentItemP">番地・アパート名:{{ $user['address_line1'] }}</p>
		</div>
		<div class="dataContentItem">
			<p class="dataContentItemP">備考欄:{{ $user['memo'] }}</p>
		</div>
